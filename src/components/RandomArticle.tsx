  ...
  return (
    <div className=' flex justify-between gap-2 p-2 mb-4 border-b border-gray-300'>
        ...
        <div className=' relative w-[400px] h-[200px]'>
            <Image src={`${data?.urlToImage ? data?.urlToImage : "/img/new-u-logo.webp"}`} alt={data?.title} fill sizes=' (max-width:768px) 50vw (max-width:1200px) 100vw, 100vw ' className=' object-cover' />
        </div>
    </div>
  )
}
